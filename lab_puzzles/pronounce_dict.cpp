...
bool PronounceDict::homophones(const string& word1, const string& word2) const
{
    ...
    string upper1 =  word1;
	  ...
	  map<string, std::vector<std::string>>::const_iterator pronounce1 = dict.find(upper1);
	  map<string, std::vector<std::string>>::const_iterator pronounce2 = dict.find(upper2);
